                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <p class="text-center p-5">
                                Bạn cần <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> hoặc <a style="color:blue" href="{{route('register.form')}}">Đăng ký</a> để nhận xét.
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">Nhận xét ({{$post->allComments->count()}})</h3>
                                    <!-- Single Comment -->
